...
class TestTicket(unittest.TestCase):
    ...
    """
    WARNING:root:optional property was not in ticket: Fahrplan.Description
    WARNING:root:optional property was not in ticket: Fahrplan.Track
    WARNING:root:optional property was not in ticket: Fahrplan.Day
    WARNING:root:optional property was not in ticket: Voctoweb.RecordingId.Master
    """
    def test_init_success(self):
        t = Ticket(self.ticket_json, 1) #args: ticket, ticket_id
